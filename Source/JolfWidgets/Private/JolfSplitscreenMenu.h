...
#include "JolfSplitscreenMenu.generated.h"

UCLASS(Abstract)
class UJolfSplitscreenMenu : public UJolfMenuStackContent
{
	GENERATED_BODY()
...
private: // Functions
	...
	UFUNCTION()
	void OnOffsetGamepadUserIndexChecked(bool bInIsChecked);
...
private: // Properties
	...
	UPROPERTY(Meta = (BindWidget))
	class UCheckBox* OffsetGamepadUserIndexCheckBox;
